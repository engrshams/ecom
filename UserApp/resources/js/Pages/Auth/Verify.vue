        ...
        <div class="container mx-auto px-4 py-8">
            <div class="max-w-md mx-auto bg-white shadow-md rounded-lg p-6">
                ...
                <p class="text-gray-600 text-center mb-6">
                    We have sent a 4-digit OTP code to your email. Please enter it below to verify your account.
                </p>
                <form @submit.prevent="verifyOTP">
                    <div class="mb-6">
                        <label for="otp" class="block text-gray-700 font-bold mb-2">Enter OTP</label>
                        <input type="text" id="otp" class="w-full p-2 border rounded-md" placeholder="Enter 4-digit OTP"
