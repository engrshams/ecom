...
//SSLCommerz may sent data by get or post so we have to make route as GET/POST Both 
...
Route::post('/login', [AuthController::class, 'login'])->name('login.post');  // login function

Route::get('/register', [AuthController::class, 'registerPage'])->name('register');
Route::post('/register', [AuthController::class, 'register'])->name('register.post');  // register function
