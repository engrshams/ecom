...
class CheckoutController extends Controller
{
    public function checkout(Request $request)
    {
        ...
        $transaction_id = uniqid();     //the returned random string will be 13 characters long.
        $delivery_status = 'Pending';   // 'Pending', 'Processing', 'Shipped', 'Delivered', 'Cancelled'
        $payment_status = 'Pending';    //'Pending', 'Success', 'Fail', 'Cancel'
        ...
        $vat = 3;   //  arbitrary vat percentage
